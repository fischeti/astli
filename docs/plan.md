...
| D4 | Column alignment is a post-pass over emitted lines | House styles (lowRISC, PULP) require aligned ports and assignments. Align runs of same-shaped siblings, broken by blank lines and comments. Precedent: gofmt's `tabwriter`. |
