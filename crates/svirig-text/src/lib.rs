...
//! buffer that expansion synthesised, and an [`Origins`] holds them all. An
//! [`Origin`] pairs the span a token's bytes live at with the [`Expansion`]
...
pub use origins::{Expansion, ExpansionId, Origin, Origins};
